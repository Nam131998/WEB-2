...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8 col-md-8">
			<h3 class="phimlienquan">Chi tiết phim</h3><br>
			<div class="row">
				<div class="col-xs-8 col-sm-4 col-md-4 image">
					<img src="public/anhda4/phim/{{$p->image}}" alt="image" width="100%">
				</div>
				<div class="col-sx-12 col-sm-8 col-md-8">
					<h2 class="text-uppercase title-movie">{{$p->tenphim}}</h2>
					<h3 class="text-uppercase title-movie en">{{$p->tentienganh}}</h3>
					<div class="movie-info">
						<div class="info">
							<label>Thời lượng:&nbsp;</label>
							<span>{{$p->thoiluong}} phút</span>
						</div>
						<div class="info">
						...
						<div class="info">
							...
							<span>{{date('d-m-Y', strtotime($p->ngaykhoichieu))}}</span>
						</div>
					</div>
				</div>
			</div>
			<div class="row noidungphim">
				<div class="col-12">
					<div class="noidung">
						...
						<div class="trailer">
							<h3 class="phimlienquan">Trailer</h3><br>
							{!!$p->trailer!!}
						</div>
					</div>
				</div>
						...
						<div id="home" class="container tab-pane active"><br>
							...
							<div class="lich mb-4">
								...
								<div class="chitietlich">
										@foreach ($l['ngay'] as $n)
									<span>
											<strong>Ngày: {{date('d-m-Y', strtotime($n->ngay))}}</strong>
									</span><br><br>
									<ul>
							...
							<div >
								@foreach ($cmtphim as $cmtp)
									...
									<div class="comment-avatar">
										<img src="public/anhda4/logo/avt.png">
									</div>
										...
										<div class="comment-footer">
											<div class="comment-info">
												<span class="comment-author">
													<a href="" style="text-decoration: none;">{{$cmtp->user->name}}</a>
												</span>
												<span class="comment-date">{{$cmtp->created_at}}</span>
											</div>
		...
		<div class="col-xs-12 col-sm-4 col-md-4">
			<h3 class="phimlienquan">Phim Liên Quan</h3>
			<div class="row">
				@foreach($phimlq as $plq)
				<div class="col-12 ">
					<div class="movie movielienquan" style="height: 450px;border-radius: 20px;">
