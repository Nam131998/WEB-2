      ...
      <div class="row">
       <div class="col-lg-12 mb-5">
        <div class="card">
            ...
            <form action="admin/formeditphim/{{$up->id}}" method="POST" class="form-horizontal">
             ...
             {{--  <input type="hidden" name="_token" value="{{ csrf_token() }} ?>"> --}}
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input id="inputHorizontalWarning" name="tenta" type="text" placeholder="Tên Tiếng Anh" value="{{$up->tentienganh}}" class="form-control form-control-warning "><small class="form-text text-muted ml-3">Chú ý :</small>
                </div>
              </div>
              <div class="form-group row">
          ...
          <a href="http://localhost/da/admin/qlyphim"><input type="button" value="BACK" class="btn btn-primary" 
