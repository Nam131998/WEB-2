        ...
        <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
          <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
            <div class="flex-grow-1 d-flex align-items-center">
              ...
              <div class="text">
                <h6 class="mb-0 " style="margin-left: -5px;">Phim Đang Chiếu</h6><span class="text-gray">{{$phimdc}}</span>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
          <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
            <div class="flex-grow-1 d-flex align-items-center">
              ...
              <div class="text">
                <h6 class="mb-0" style="margin-left: -5px;">Phim Sắp Chiếu</h6><span class="text-gray">{{$phimsc}}</span>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
          <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
            <div class="flex-grow-1 d-flex align-items-center">
              ...
              <div class="text">
                <h6 class="mb-0 " style="margin-left: -5px;">Tin Tức</h6><span class="text-gray">{{$tintuc}}</span>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
          <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
            <div class="flex-grow-1 d-flex align-items-center">
              ...
              <div class="text">
                <h6 class="mb-0" style="margin-left: -5px;">Thành Viên</h6><span class="text-gray">{{$thanhvien}}</span>
              </div>
            </div>
            ...
            <div class="card-body">
              <table class="table">
                <tr>
                  <th>STT</th>
                  <th>Tên Phim</th>
                  <th style="text-align: center;">Vé Đã Bán</th>
                </tr>
                @php
                  $stt=0;
                  if (isset($_GET['page'])) {
                ...
                <tr>
                  ...
                  <td style="text-align: center;">{{$l->id_rap}}</td>
                </tr>
                @endforeach
