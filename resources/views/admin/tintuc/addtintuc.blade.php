						...
						<div class="card-body">
							<form action="{{url('admin/addtintuc')}}" method="POST" class="form-horizontal">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<input id="inputHorizontalSuccess" name="tentintuc" type="text" placeholder="Tiêu đề"  class="form-control form-control-success" required><small class="form-text text-muted ml-3">Chú ý : .</small>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">Ảnh Tin Tức</label>
									<div class="col-md-9">
										<input id="inputHorizontalWarning" name=anhtintuc type="file"  class="form-control form-control-warning" required><small class="form-text text-muted ml-3">Chú ý :</small>
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<textarea class="form-control " name="ndtintuc" rows="5" id="noidungtt" required></textarea><small class="form-text text-muted ml-3">Chú ý :</small>
									</div>
								</div>
								<div class="form-group row">       
