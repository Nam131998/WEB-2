						...
						<div class="card-body">
							<form action="{{url('admin/addlich')}}" method="POST" class="form-horizontal">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<select name="rap" class="form-control" id="rap" required="">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<select name="phong" class="form-control" id="phong" required="">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<input id="inputHorizontalWarning" name="ngay" type="date"  class="form-control form-control-warning" required><small class="form-text text-muted ml-3">Chú ý :</small>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">Thời gian</label>
									<div class="col-md-9">
										<input id="inputHorizontalWarning" name="time" type="time"  class="form-control " required><small class="form-text text-muted ml-3">Chú ý :</small>
									</div>
								</div>
								<div class="form-group row">       
