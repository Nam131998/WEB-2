							...
							<table class="table table-hover card-text" style="text-align: center;">
								...
								<tbody>
									...
									<tr>
										...
										@endif
										{{-- <td>{{$tt->theloai}}</td> --}}
										<td><img src="public/anhda4/tintuc/{{$tt->image}}" width="80px"></td>
										<td><a href="admin/edittintuc/{{$tt->id}}"><button style="background-color: #ffffff00;border: none;margin-right:50px;" title="Sửa"><i class="fas fa-edit text-success"></i></button></a><br>
