...
<div class="col-lg-12 pt-3">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('rap')}}">Rạp</a></li>	
                        </ol>
</div>
...
<div class="row ticket-price-wrapper pt-2">
	<div class="col-md-6 col-xs-12">
		...
		<div class="row theater-showtimes mt-4 mb-4">
			<div  >
				...
				<h3 class="pdc mt-3 ml-3" style="text-transform: uppercase;">Kết Quả</h3>
					{{-- <select name="rap" id="rap" style="border:1px solid black;">
						<option value="0" checked>Chọn Ngày</option>
						<option value="1" >05/10/2019</option>
						<option value="2" >10/10/2019</option>
						<option value="3" >15/10/2019</option>
						<option value="4" >20/10/2019</option>
					</select> --}}
				</form>
			</div>
		</div>
		<div id="duyetngay">
			{{-- <div class="row" > --}}
{{-- 				<div class="col-md-3">
			<img style="width: 130px;height: auto;float: left;margin-right: 30px;"
			 src="public/anhda4/phim/caption.jpg" alt="">
			 </div>
			<div class="col-md-9"> --}}
				{{-- <h4 class="ng-binding">ĐẠI ÚY MARVEL</h4>
				<div class="ticket-showtime-icon">
					...
					<div class="gio mt-3">
						<ul>
							<a href="#"><li>20:20</li></a>
							<a href="#"><li>21:20</li></a>
							<a href="#"><li>22:20</li></a>
						</ul>
					</div>
				</div> --}}
			{{-- </div> --}}
